...
import com.boha.golfpractice.player.fragments.CoachSummaryFragment;
...
import com.boha.golfpractice.player.fragments.PlayerListFragment;
    ...
    public void onActivityResult(int reqCode, int rescode, Intent data) {
        ...
        switch (reqCode) {
            ...
            case THEME_REQUESTED:
                if (rescode == RESULT_OK) {
                    finish();
                    Intent w = new Intent(this, CoachMainActivity.class);
                    startActivity(w);
                }
                break;
        }
