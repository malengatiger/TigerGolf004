...
import com.boha.golfpractice.player.dto.HoleDTO;
import com.boha.golfpractice.player.dto.HoleStatDTO;
...
import com.boha.golfpractice.player.fragments.GolfCourseListFragment;
import com.boha.golfpractice.player.fragments.PageFragment;
import com.boha.golfpractice.player.fragments.SessionListFragment;
import com.boha.golfpractice.player.fragments.SessionSummaryFragment;
import com.boha.golfpractice.player.util.DepthPageTransformer;
...
public class PlayerMainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Util.setCustomActionBar(ctx, getSupportActionBar(), "TGolf", "",
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_theme) {
            Intent m = new Intent(getApplicationContext(),ThemeSelectorActivity.class);
            startActivityForResult(m,THEME_REQUESTED);
            return true;
        }
        if (id == R.id.action_video) {
            Intent m = new Intent(getApplicationContext(),VideoCaptureActivity.class);
            startActivityForResult(m,YOUTUBE_VIDEO_RECORDING);
            return true;
        }
    ...
    static final int THEME_REQUESTED = 1762, YOUTUBE_VIDEO_RECORDING = 283;
    ...
    public void onActivityResult(int reqCode, int resCode, Intent data) {
        switch (reqCode) {
            ...
            case THEME_REQUESTED:
                if (resCode == RESULT_OK) {
                    finish();
                    Intent w = new Intent(this, PlayerMainActivity.class);
                    startActivity(w);
                }
                break;
        }
