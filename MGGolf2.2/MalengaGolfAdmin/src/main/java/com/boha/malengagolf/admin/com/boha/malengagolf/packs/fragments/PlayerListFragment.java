...
import com.boha.malengagolf.library.activities.PlayerHistoryActivity;
import com.boha.malengagolf.library.adapters.PlayerListAdapter;
...
public class PlayerListFragment extends Fragment implements PageFragment {
    ...
    public void setList(boolean forceImageRefresh, int index) {
        ...
        personAdapter = new PlayerListAdapter(
                playerList, ctx,
                new PlayerListAdapter.PlayerAdapterListener() {
                    @Override
