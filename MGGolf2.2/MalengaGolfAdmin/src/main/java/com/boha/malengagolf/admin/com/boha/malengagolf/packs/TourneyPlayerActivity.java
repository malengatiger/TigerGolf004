                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (leaderBoardList != null) {
                            txtCount.setText("" + leaderBoardList.size());
                            setList();
                            recyclerView.scrollToPosition(leaderBoardList.size() - 1);
...
//                txtCount.setText("" + leaderBoardList.size());
//                setList();
//                recyclerView.setSelection(leaderBoardList.size() - 1);
//                CacheUtil.cacheData(ctx,response, CacheUtil.CACHE_LEADER_BOARD, tournament.getTournamentID(), new CacheUtil.CacheUtilListener() {
//                    @Override
//                    public void onFileDataDeserialized(ResponseDTO response) {
//
...
//        });
    ...
    private void setFields() {
        ...
        imgSort = (ImageView) findViewById(R.id.TP_imageSort);
        recyclerView = (RecyclerView) findViewById(R.id.TP_listView);
    ...
    private void setList() {
        ...
        adapter = new TourneyPlayerListAdapter(ctx,
                ...
                tournament.getPar(), useAgeGroups, false, new TourneyPlayerListAdapter.TourneyPlayerListener() {
            @Override
