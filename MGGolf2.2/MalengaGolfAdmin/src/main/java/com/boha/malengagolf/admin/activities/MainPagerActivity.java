...
import com.boha.malengagolf.library.activities.ThemeSelectorActivity;
...
import com.boha.malengagolf.library.util.DepthPageTransformer;
...
public class MainPagerActivity extends AppCompatActivity
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(LOG, "onCreate ..........................");
        setContentView(R.layout.main_pager3);
                    ...
                    public void run() {
                        ...
                        CacheUtil.cacheData(ctx, r, CacheUtil.CACHE_NEAREST_CLUBS, new CacheUtil.CacheUtilListener() {
                            ...
                            public void onDataCached() {
                                SugarUtil.edit(response, new SugarUtil.SugarListener() {
                                    @Override
...
//    }
    ...
    private void getGolfGroupData() {
        ...
        MGApp app = (MGApp) getApplication();
        BaseVolley.sendRequest(Statics.SERVLET_ADMIN, r, ctx, app, new BaseVolley.BohaVolleyListener() {
            @Override
            public void onResponseReceived(ResponseDTO r) {
                setNotBusy();
    ...
    static final int REQUEST_IMPORT_PLAYERS = 3733, THEME_SELECTION = 908;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.menu_theme:
                ...
                startActivityForResult(m, THEME_SELECTION);
                return true;
    ...
    private void goOffLine() {
        ...
        SugarUtil.getAllData(new SugarUtil.SugarListener() {
            @Override
            public void onDataWritten(int statusCode) {
    ...
    private void initializeAdapter() {
        ...
        mPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int arg0) {
                ...
                SharedUtil.setPageIndex(ctx, currentPageIndex);
            }
        ...
        mPager.setCurrentItem(SharedUtil.getPageIndex(ctx));
    }
        ...
        switch (requestCode) {
            case THEME_SELECTION:
                if (resultCode == Activity.RESULT_OK) {
                    finish();
                    Intent w = new Intent(this, MainPagerActivity.class);
                    startActivity(w);
                }
                break;
