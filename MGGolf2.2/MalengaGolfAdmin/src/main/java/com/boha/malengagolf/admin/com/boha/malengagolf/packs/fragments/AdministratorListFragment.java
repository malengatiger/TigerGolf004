...
import com.boha.malengagolf.library.adapters.AdminListAdapter;
...
public class AdministratorListFragment extends Fragment implements PageFragment {
    ...
    public void setList(boolean forceImageRefresh, int index) {
        ...
        adapter = new AdminListAdapter(administratorList, ctx,
                new AdminListAdapter.AdministrationAdapterListener() {
                    @Override
