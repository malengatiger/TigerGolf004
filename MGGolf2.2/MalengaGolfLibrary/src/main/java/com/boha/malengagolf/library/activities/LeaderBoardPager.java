    ...
    public boolean isActivityRunning() {
        ...
        for (int i = 0; i < services.size(); i++) {
            ...
            if (services.get(i).topActivity.toString().equalsIgnoreCase(
                    "ComponentInfo{com.boha.malengagolf.admin/com.boha.malengagolf.library.activities.LeaderBoardPager}")) {
                isActivityFound = true;
            }
            if (services.get(i).topActivity.toString().equalsIgnoreCase(
                    "ComponentInfo{com.boha.malengagolf.scorer/com.boha.malengagolf.library.activities.LeaderBoardPager}")) {
                isActivityFound = true;
            }
            if (services.get(i).topActivity.toString().equalsIgnoreCase(
                    "ComponentInfo{com.boha.malengagolf.player/com.boha.malengagolf.library.activities.LeaderBoardPager}")) {
                isActivityFound = true;
            }
        }
