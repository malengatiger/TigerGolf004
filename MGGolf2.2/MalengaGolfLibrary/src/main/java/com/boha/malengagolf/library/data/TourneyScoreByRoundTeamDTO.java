 ...
 */
public class TourneyScoreByRoundTeamDTO  extends SugarRecord implements Serializable {
    ...
    private int totalScore, totalPoints, par, holesPerRound;
    private int leaderBoardTeamID, tournamentID;
