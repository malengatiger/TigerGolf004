 ...
 */
public class ScorerListAdapter extends RecyclerView.Adapter<ScorerListAdapter.AdminViewHolder>{

    public interface ScorerAdapterListener {
        public void onCameraRequested(ScorerDTO p, int position);
    ...
    public ScorerListAdapter(List<ScorerDTO> list,
                             Context context, ScorerAdapterListener listener) {
        this.mList = list;
        this.ctx = context;
    ...
    static final String LOG = ScorerListAdapter.class.getSimpleName();
